...
class Calculator {
    ...
    String createUniqueID(String n) {
        ...
        int randomSplit = r.nextInt(uuid.length() - 1) + 1;
        String firsthalf = uuid.substring(0, randomSplit);
        String secondhalf = uuid.substring(randomSplit);
        return firsthalf + n + secondhalf;
    }
